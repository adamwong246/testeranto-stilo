...
exports.createFabellibro = createFabellibro;
...
function createFabellibro(port = 3000, samplesPath) {
    ...
    const samplesDir = samplesPath || path_1.default.join(__dirname, '..', 'samples');
...
// Default export
exports.default = createFabellibro;
